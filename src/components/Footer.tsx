            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {galleryImages.map((src, i) => (
                <motion.div
                  ...
                  className="relative group aspect-[4/5] bg-brand-elevated rounded-2xl overflow-hidden border border-white/5 transition-all duration-500"
                >
                  <img 
                    src={src} 
                    alt={`Gallery ${i}`} 
                    className="w-full h-full object-cover grayscale opacity-40 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-[1.5s] ease-out group-hover:scale-110"
                  />
